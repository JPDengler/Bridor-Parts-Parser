...
# Filters
FILTER_KEYWORDS = ["Shift Report", "Maintenance shift report", "mech shift report", "Night shift", "Maintenance Automation Weekly Report"]

# Lines to remove
LINES_TO_REMOVE = ["*", "<", "Confidentiality Warning"]
